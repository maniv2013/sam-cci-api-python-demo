...
```bash
sam-cci-api-python-demo$ sam logs -n HelloEfsFunction --stack-name sam-cci-api-python-demo --tail
```
...
```bash
sam-cci-api-python-demo$ pip install -r tests/requirements.txt --user
# unit test
sam-cci-api-python-demo$ python -m pytest tests/unit -v
# integration test, requiring deploying the stack first.
# Create the env variable AWS_SAM_STACK_NAME with the name of the stack we are testing
sam-cci-api-python-demo$ AWS_SAM_STACK_NAME=<stack-name> python -m pytest tests/integration -v
```
...
```bash
aws cloudformation delete-stack --stack-name sam-cci-api-python-demo
```
